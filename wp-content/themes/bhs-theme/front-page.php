<?php get_header(); ?>
                         ...
                         <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <img src="<?php bloginfo('template_url'); ?>/images/front-page.jpg" alt="front page image" class="img-fluid">
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
                                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/images/bhs-clinic-ad.png" alt="clinic ad image" class="img-fluid"></a>
                                </div>
